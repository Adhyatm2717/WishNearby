...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      const complete = localStorage.getItem("wishnearby-onboarding-complete") === "true";
      const mode = localStorage.getItem("wishnearby-experience");
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-mesh">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2 text-sm">Sign in to your community account</p>
        </div>
